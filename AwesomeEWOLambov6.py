...
def EWO(dataframe, ema_length=5, ema2_length=3):
    ...
    return emadif
class AwesomeEWOLambov6(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        percentage_increases = [1 + i/100 for i in range(3, 5)]
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dont_buy_conditions.append((dataframe['price_spike_warn'] == -1))
        dont_buy_conditions.append((dataframe['volume_price_ratio_warn'] == -1))
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        sellsignal =(
            (dataframe['ha_close'] > dataframe['ha_open']) &
            (dataframe['difference_signal'] >= 2.3) 
        )
